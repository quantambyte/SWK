...
const BusinessModel = () => {
  ...
  return (
    <section className="bg-[#f5f5f5] dark:bg-dark-bg w-full mx-auto py-20 px-4 sm:px-10 md:px-20 lg:px-32 text-center font-poppins">
      ...
      <div className="grid gap-12 md:grid-cols-3">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-8 hover:shadow-lg transition-shadow duration-300 ease-in-out relative">
          <FaCogs className="text-5xl text-middleBlue dark:text-brand mb-4 mx-auto" />
        ...
        <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-8 hover:shadow-lg transition-shadow duration-300 ease-in-out relative">
          <FaLaptopCode className="text-5xl text-middleBlue dark:text-brand mb-4 mx-auto" />
        ...
        <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-8 hover:shadow-lg transition-shadow duration-300 ease-in-out relative">
          <FaUsers className="text-5xl text-middleBlue dark:text-brand mb-4 mx-auto" />
          <h3 className="text-2xl font-semibold text-gray-800 dark:text-white mb-4">
            {t("title3")}
          </h3>
